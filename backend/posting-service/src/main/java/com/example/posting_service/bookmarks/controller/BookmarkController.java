...
public class BookmarkController {
    ...
    public List<BookmarkEntity> getAllBookmarks(@RequestParam int userId){
    ...
    public String removeBookmark(@RequestParam int bookmarkedByUserId, @RequestParam Long bookmarkedPostId){
    ...
    public List<PostEntity> getPostEntityBasedOnBookmarks(@RequestParam int userId){
