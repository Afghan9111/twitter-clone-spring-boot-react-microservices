...
import "../styles/components-styles/PostModal.css";
import type { User } from "../types/Users/User";
import { useState, useRef } from "react";
import { POST_TEXT_LENGTH } from "../constants/MiscConstants";
import EmojiDialogBox from "./EmojiDialogBox";
import GiphyDialogBox from "./GiphyDialogBox";
import PostTextBar from "./PostTextBar";
import { toast } from "react-toastify";
import { uploadMedia } from "../api/MediaService";
import { saveNewPost } from "../api/PostingService";
...
export default function PostModal({ userInfo, isVisible, setIsVisible, refer, replyingToPostId, replyingToUserId }: PostModalProps) {
                        ...
                        <X color="black" className="closePostModal" onClick={() => { setIsVisible(!isVisible) }} />
                        {
                            replyingToUserId && (
                                <div style={{fontSize:"18px", }}>
                                    ...
                                    <span style={{color:"blue"}}>{`@${replyingToUserId}`}</span>
                                </div>
                            )
                        }
                    </div>
