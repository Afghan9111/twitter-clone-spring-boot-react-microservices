...
import { deletePostByPostId } from "../api/PostingService";
import { queryClient } from "../main";
import type { User } from "../types/Users/User";
import { deleteLikeEntity, addLike } from "../api/LikeService";
import type { PostEntity } from "../types/Posts/PostEntity";
import type { AxiosResponse } from "axios";
import type { UseQueryResult } from "@tanstack/react-query";
import { addBookmark, removeBookmarkEntity } from "../api/BookmarkService";
